...
namespace Task7.Handlers
{
    ...
    {
        IDbService _db;
        public BasicAuthHandler(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, IDbService db) 
        ...
        protected  override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var student=_db.GetStudent(password);
